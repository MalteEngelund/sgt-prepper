...
export const cookieBannerView = () => {
  const overlay = Div('fixed hidden inset-0 z-[9998] bg-black/50 flex items-end md:items-center md:justify-center')
  ...
  text.innerText = 'vi bruger cookies til statistik og marketing'
  ...
  const acceptSome = Button('Kun nødvendige', 'button', 'px-3 py-2 bg-[#222]text-white rounded-md font-semibold')
